...
let incr_mod : Prims.pos  ->  int_t  ->  int_t = (fun ( n  :  Prims.pos ) ( a  :  int_t ) -> (Prims.mod_f (a + (Prims.parse_int "1")) (Prims.pow2 (n - (Prims.parse_int "1")))))


let decr_mod : Prims.pos  ->  int_t  ->  int_t = (fun ( n  :  Prims.pos ) ( a  :  int_t ) -> (Prims.mod_f (a - (Prims.parse_int "1")) (Prims.pow2 (n - (Prims.parse_int "1")))))
...
let ne : Prims.pos  ->  int_t  ->  int_t  ->  Prims.bool = (fun ( n  :  Prims.pos ) ( a  :  int_t ) ( b  :  int_t ) -> (Prims.op_disEquality a b))
