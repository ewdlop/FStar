...
let uint_to_t : FStar_UInt.uint_t  ->  t = (fun ( x  :  FStar_UInt.uint_t ) -> {low = (FStar_UInt64.uint_to_t (Prims.mod_f x (Prims.pow2 (Prims.parse_int "64")))); high = (FStar_UInt64.uint_to_t (x / (Prims.pow2 (Prims.parse_int "64"))))})
...
let l32 : FStar_UInt.uint_t  ->  FStar_UInt.uint_t = (fun ( x  :  FStar_UInt.uint_t ) -> (Prims.mod_f x (Prims.pow2 (Prims.parse_int "32"))))
...
let mul_wide_low : FStar_UInt64.t  ->  FStar_UInt64.t  ->  Prims.int = (fun ( x  :  FStar_UInt64.t ) ( y  :  FStar_UInt64.t ) -> ((Prims.mod_f (((plh x y) + (Prims.mod_f ((phl x y) + (pll_h x y)) (Prims.pow2 (Prims.parse_int "32")))) * (Prims.pow2 (Prims.parse_int "32"))) (Prims.pow2 (Prims.parse_int "64"))) + (pll_l x y)))


let mul_wide_high : FStar_UInt64.t  ->  FStar_UInt64.t  ->  Prims.int = (fun ( x  :  FStar_UInt64.t ) ( y  :  FStar_UInt64.t ) -> (((phh x y) + (((phl x y) + (pll_h x y)) / (Prims.pow2 (Prims.parse_int "32")))) + (((plh x y) + (Prims.mod_f ((phl x y) + (pll_h x y)) (Prims.pow2 (Prims.parse_int "32")))) / (Prims.pow2 (Prims.parse_int "32")))))
