...
let incr_mod : Prims.nat  ->  uint_t  ->  uint_t = (fun ( n  :  Prims.nat ) ( a  :  uint_t ) -> (Prims.mod_f (a + (Prims.parse_int "1")) (Prims.pow2 n)))


let decr_mod : Prims.nat  ->  uint_t  ->  uint_t = (fun ( n  :  Prims.nat ) ( a  :  uint_t ) -> (Prims.mod_f (a - (Prims.parse_int "1")) (Prims.pow2 n)))
...
let add_mod : Prims.nat  ->  uint_t  ->  uint_t  ->  uint_t = (fun ( n  :  Prims.nat ) ( a  :  uint_t ) ( b  :  uint_t ) -> (Prims.mod_f (a + b) (Prims.pow2 n)))
...
let sub_mod : Prims.nat  ->  uint_t  ->  uint_t  ->  uint_t = (fun ( n  :  Prims.nat ) ( a  :  uint_t ) ( b  :  uint_t ) -> (Prims.mod_f (a - b) (Prims.pow2 n)))
...
let mul_mod : Prims.nat  ->  uint_t  ->  uint_t  ->  uint_t = (fun ( n  :  Prims.nat ) ( a  :  uint_t ) ( b  :  uint_t ) -> (Prims.mod_f (a * b) (Prims.pow2 n)))
...
let ne : Prims.nat  ->  uint_t  ->  uint_t  ->  Prims.bool = (fun ( n  :  Prims.nat ) ( a  :  uint_t ) ( b  :  uint_t ) -> (Prims.op_disEquality a b))
...
let to_uint_t : Prims.nat  ->  Prims.int  ->  uint_t = (fun ( m  :  Prims.nat ) ( a  :  Prims.int ) -> (Prims.mod_f a (Prims.pow2 m)))
...
| uu___ -> begin
(FStar_Seq_Base.append (to_vec (n - (Prims.parse_int "1")) (num / (Prims.parse_int "2"))) (FStar_Seq_Base.create (Prims.parse_int "1") (Prims.op_Equality (Prims.mod_f num (Prims.parse_int "2")) (Prims.parse_int "1"))))
end))
...
let zero_extends_vec : Prims.pos  ->  Prims.pos  ->  FStar_BitVector.bv_t  ->  FStar_BitVector.bv_t = (fun ( n  :  Prims.pos ) ( m  :  Prims.pos ) ( a  :  FStar_BitVector.bv_t ) -> (FStar_Seq_Base.append (FStar_BitVector.zero_vec m) a))
...
let zero_extends : Prims.pos  ->  Prims.pos  ->  uint_t  ->  uint_t = (fun ( n  :  Prims.pos ) ( m  :  Prims.pos ) ( a  :  uint_t ) -> (from_vec (n + m) (zero_extends_vec n m (to_vec n a))))
